...
export const APPLE_CARDS: FoodCard[] = [
  { id: "red_apple",   name: "紅蘋果", img: `${process.env.NEXT_PUBLIC_BASE_PATH ?? ""}/img/chapter4taskfruit/apple1.png`, type: "apple" },
  { id: "green_apple", name: "青蘋果", img: `${process.env.NEXT_PUBLIC_BASE_PATH ?? ""}/img/chapter4taskfruit/apple2.png`, type: "apple" },
  { id: "small_apple", name: "小蘋果", img: `${process.env.NEXT_PUBLIC_BASE_PATH ?? ""}/img/chapter4taskfruit/apple3.png`, type: "apple" },
];

export const BANANA_CARDS: FoodCard[] = [
  { id: "banana",        name: "香蕉",   img: `${process.env.NEXT_PUBLIC_BASE_PATH ?? ""}/img/chapter4taskfruit/banana1.png`, type: "banana" },
  { id: "small_banana",  name: "小香蕉", img: `${process.env.NEXT_PUBLIC_BASE_PATH ?? ""}/img/chapter4taskfruit/banana2.png`, type: "banana" },
  { id: "curved_banana", name: "彎香蕉", img: `${process.env.NEXT_PUBLIC_BASE_PATH ?? ""}/img/chapter4taskfruit/banana3.png`, type: "banana" },
];
